        ...
        <div className="lg:w-1/2 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <input
              ...
              className={`w-full bg-white rounded border shadow-inner ${errors.email ? 'border-red-500' : 'focus:border-primary-300'} text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out`}
            />
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              name="subject"
              placeholder='Subject'
              className={`w-full bg-white rounded border shadow-inner ${errors.subject ? 'border-red-500 ' : 'focus:border-primary-400'} text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out`}
            />
          ...
          <div className="relative mb-4">
            ...
            <textarea
              ...
              className={`w-full bg-white rounded border shadow-inner ${errors.message ? 'border-red-500 ' : 'focus:border-primary-400'} h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out`}
              defaultValue={""}
            />
            {errors.message && <span className="text-red-500">Message is required</span>}
          </div>
            <button className="btn flex items-center gap-2 justify-center outline-none">
              Send Message
