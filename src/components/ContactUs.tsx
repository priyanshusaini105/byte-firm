        ...
        <div className="lg:w-1/2 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          ...
          <form action={handleEmail}>
            <div className="mb-4">
              ...
              <input
                ...
                // })}
                name='name'
                className={`w-full bg-white rounded-md border focus:border-primary-500 focus:border-primary-500 text-base outline-none text-gray-700 py-2 px-4 leading-8 transition-colors duration-200 ease-in-out`}
          ...
          <div className="relative mb-4">
            ...
            <textarea
              ...
              className={`w-full bg-white rounded border shadow-inner focus:border-primary-500 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out`}
              defaultValue={""}
            />
            {/* {errors.message && <span className="text-red-500">Message is required</span>} */}
          </div>
            <button className="btn flex items-center gap-2 justify-center" type="submit">
              Send Message
