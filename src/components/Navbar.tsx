...
export default function Navbar() {
  ...
  return (
    <nav className="navbar flex w-full justify-between w-full px-4 py-2 items-center md:px-6">
        <div className="">
        ...
        <div className="transition-all md:hidden">
          <div className="h-full absolute w-[100vw] top-0 left-0 overflow-x-hidden ">
            ...
            >
              <div className="relative w-full h-full  text-white mt-20 flex flex-col gap-6">{navItems.map((item) => {
