...
export const Hero: FC<Props> = () => {
  return (
    <section className="flex justify-between w-full flex-col md:flex-row md:p-12 p-8 mt-16">
      <Fade top>
        <div className="w-full p-4 text-white relative">
          ...
          <h3 className="text-4xl md:text-5xl lg:text-6xl block relative md:left-0 font-bold text-accent-400">
            Reality.
          </h3>
